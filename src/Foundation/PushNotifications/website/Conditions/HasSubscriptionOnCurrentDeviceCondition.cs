...
{
    public class HasSubscriptionOnCurrentDeviceCondition<T> : StringOperatorCondition<T> where T : RuleContext
    {
        ...
        protected override bool Execute(T ruleContext)
        {
            ...
            var subscription = PushSubscriptionManager.Current[Tracker.Current.Interaction.DeviceId];
